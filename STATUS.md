...
Current step: **phase 2, step 9 (multi-FILE cue sheets)**. Step 8 (input robustness) done. Repo on github.com/ddp-reverse-eng/ddp-reverse-eng (user pushes; CI = GitHub Actions in step 13).
