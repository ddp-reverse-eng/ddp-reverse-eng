...
Current step: **phase 2, step 8b (cue syntax variants)**. 8a (WAV variants) done. Hosting: user leans away from GitHub; Codeberg suggested, awaiting decision before CI (step 13).
