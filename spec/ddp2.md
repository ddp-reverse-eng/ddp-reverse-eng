...
CD-Text: cue commands COMPOSER, ARRANGER and MESSAGE (disc and track level) are encoded as pack types 0x83, 0x84 and 0x85, with the same text layout as 0x80-0x82 and after them in type order [091]. Evidence: cdtinfo decodes every field as written, and cue2ddp given our CDTEXT.BIN as CDTEXTFILE produces a byte-identical fileset [091]→[092]. cue2ddp itself ignores these commands with a warning [070]. Like cue2ddp, the writer never emits UPC/ISRC (0x8E), genre (0x87) or disc ID (0x86) packs [025]; these wait for a real-world sample.
